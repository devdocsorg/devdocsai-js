...
describe('ChatView', () => {
  ...
  it('allows users to ask multiple questions', async () => {
    ...
    devdocsaiData = { conversationId, promptId };
    response = ['answer'];
    ...
    devdocsaiData = { conversationId, promptId: nextPromptId };
  ...
  it('does not save conversations when disabled', async () => {
    ...
    expect(localStorage.getItem('devdocsai')).toBeNull();
  });
